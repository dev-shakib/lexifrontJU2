...
const Otpregfun = () => {
  ...
  const Postonclick = (e) => {
    ...
    // user_id', 'email', 'password', 'otp', 'confirm_otp'
  ...
  // console.log('this is otp dta',location.state)
  
  return (
    // <div>Otpregfun
    //   <div>{otpdataa.email}</div> 
    // </div>
    // <React.Fragment>
    // <this.DummyView/>
    <div>
       ...
       <form>
         <FormGroup style={{ width: '400px' }} className="ml-5">
           ...
           >
             ...
             <br />
             <div>
             Please input the OTP, we just sent to <span style={{color:'green'}}>{otpdataa.email}</span>
             </div>
           </span>
