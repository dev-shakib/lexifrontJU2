    ...
    <Page className="mt-0" style={{ background: '#172231' }}>
      <Row className="border border-dark">
        <Col md={8} sm={6} xs={12}>
          ...
          <Row className="p-3 border border-dark" style={{height:'70px'}}>
        ...
        <Col md={4} sm={6} xs={12} >
          <Row className="p-3">
            ...
            style={{borderRadius:'10px',border:'1.5px solid rgba(30, 185, 114, 0.54)',textAlign:'left'}} >
               Update Configuration <MdCheck style={{position:'absolute',marginTop:'5px',
               right:'25px',color:'green',border:'1.5px solid rgba(30, 185, 114, 0.54)'}}
               className="rounded-circle "  /></button>
          </Row>
          <Row className="p-3">
            <button className="btn form-control text-white" 
            style={{borderRadius:'10px',background:'#1EB972',textAlign:'left'}} >Save as a new Configuration
            <MdInsertDriveFile style={{position:'absolute',marginTop:'5px',
               right:'25px',}}
               /></button>
          </Row> 
          <Row className="p-3">
            <button className="btn form-control text-white" 
            style={{borderRadius:'10px',background:'#E94F2E',textAlign:'left'}} >Delete Configuration
            <MdDelete style={{position:'absolute',marginTop:'5px',
               right:'25px'}}
               />
            </button>
          </Row>             
