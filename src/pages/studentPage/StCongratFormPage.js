...
import congratImage from 'assets/img/logo/congrat.png';

class StCongratFormPage extends React.Component {
  state = {
    modal: false,
    showPassword: false,
    checkedA: true,
        ...
        >
          <div className="d-flex align-items-center">
            <form action="/loginform">
              <FormGroup style={{ width: '400px' ,textAlign:'center'}} className="ml-5">
                ...
                >
                  ...
                  Your information has been recorded, You can now login with your new credentials
                  </div>
                </span>
...
export default StCongratFormPage;
