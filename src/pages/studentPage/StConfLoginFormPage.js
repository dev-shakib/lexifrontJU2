...
const StConfLoginFormPage = () => {
  ...
  const DropdownIndicator = props => {
    return (
      <components.DropdownIndicator {...props}>
        <img height="23" src={starrowImage} />
      </components.DropdownIndicator>
    );
  };
            ...
            >
              ...
              <FormGroup className="p-4">
                <div className="d-flex justify-content-end ">
                  <img height="21" src={helpImg} />
                </div>
                <div style={{textAlign:'center'}}>
                <img width="35" height="35" src={checkedImg} /></div>
                <div className="p-3" style={{textAlign:'center'}}><span
                  style={{
                    color: '#232526',
                ...
                <div style={{textAlign:'center'}}>
                  <span>you can select a configuration file if you want and 
                  <br/>
                  you can start working with Activities.
                  </span>
                </div>
                <div className="pt-2">
                <MyComponentConfig />
                ...
                <Button
                  className="mt-3 border-0 form-control"
                  style={{
                    background: '#018FF7',
                    borderRadius: '10px',
...
export default StConfLoginFormPage;
