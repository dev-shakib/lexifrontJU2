...
const ActivityFourPage = () => {
  ...
  const [resultAgain, setResultAgain] = useState(false);
  ...
  const [doneClickA, setDoneClickA] = useState('none');
  const [threeBtnAgain, setThreeBtnAgain] = useState(false);
  const [wordToolTipFour, setWordToolTipFour] = useState('none');
  const [threeBtnBack, setThreeBtnBack] = useState('#17AE69');
  const [fourBtnBg, setFourBtnBg] = useState('rgba(255, 255, 255, 0.08)');
  const [startValClick, setStartValClick] = useState(false);
  ...
  const correctClick = () => {
    ...
    setDoneClickA('');
    setWordToolTip('none');
    setThreeBtnBack('rgba(30, 185, 114, 0.08)');
  };
  const correctBClick = () => {
    setCorrectB('true');
  };
  const seeResultClick = () => {
    setResultClick('true');
  };
  const resPlayAgainClick = () => {
    setResultAgain('true');
  };
  const upButtonStyle = {
    width: '100px',
  ...
  const startClick = () => {
    setStartValClick(true);
    setThreeBtnBack('rgba(30, 185, 114, 0.08)');
    setWordToolTip('none');
    setWordToolTipFour('none');
  };
  const showWords = () => {
    setThreeBtnAgain(!threeBtnAgain);
    if (!threeBtnAgain){
      setWordButton({
        namef: [
          { name: 'Dat' },
      ...
      setWordToolTip('');
      setWordToolTipFour('none');
      setThreeBtnBack('#17AE69');
      setFourBtnBg('rgba(30, 185, 114, 0.08)');
    }else{
      setWordToolTip('none');
      setThreeBtnBack('rgba(30, 185, 114, 0.08)');
    }
  ...
  return (
    <Page className="mt-0" style={{ background: '#172231' }}>      
      <Row className="pl-3">
        <Col className="pt-3">
          {startValClick? <Row className="mr-2 mt-2 ml-0 w-100" >
          <Col className="pt-1">
        <a href="/stmenu">
              <div
                className="ml-3 "
          ...
          <div style={{ display: wordToolTip }}>
            <div style={tootipStyleAgain}></div>
          </div>
          
          <Row
        className="flex-row justify-content-center align-items-center ml-0 mt-5 mb-4 mr-4"
        style={{ height: '400px', background: '#1EB972', borderRadius: '5px',position:'absolute'
      ,width:'calc(100vw*0.783)',zIndex:1 ,display: wordToolTip }}
      >
        <Row className="p-3">          
      ...
      {startValClick? (!correctB ? (
        <Row className="pl-3" style={{ background: '#172231' }}>
            ...
            >
              ...
              <Col md={6} className="flex-row justify-content-center mt-5 mb-0">
                <Row classNam="flex-row justify-content-center mt-4 mb-4 ml-4 mr-4">
                  <Col className="ml-5 flex-row justify-content-center">
                  <div className="ml-5 flex-row justify-content-center" style={graphShow}>
                    <span
                ...
                >
                  <Col md={3} xs={12} className="p-0">
                    <Button style={wordButtonStyle}>R</Button>
                  </Col>
                  <Col md={3} className="d-flex justify-content-center p-0 ">
                    <Button className="border-0 text-white" style={wordButtonStyle}>
                    I
                    </Button>
                  </Col>
                  <Col md={3} className="d-flex justify-content-center p-0">
                    <Button className="border-0" style={wordButtonStyle}>
                    E
                    </Button>
                  </Col>
                  <Col md={3} className="d-flex justify-content-center pl-5 text-white">
                    <Button className="border-0 text-white" style={wordButtonStyle}>
                    E
                    </Button>
                  </Col>
        ...
        <Col>
        <Row
        className="flex-row justify-content-center align-items-center ml-3 mt-1 mb-4 mr-4"
        style={{ height: '400px', background: '#1EB972', borderRadius: '5px' }}
      >
        <Row className="p-3">          
          {wordButton.namef.map(({ name }) => (
            <div className="pl-2">
      ...
      <Row className="flex-row justify-content-center align-items-center p-4  ">
        <div
          className="p-2 w-100 mr-1"
          style={{
            textAlign: 'center',
            background: 'rgba(255, 255, 255, 0.08)',
            border: '2px solid rgba(255, 255, 255, 0.1)',
...
export default ActivityFourPage;
